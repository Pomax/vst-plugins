...
impl Editor {
    /// Load `path` into the editor, replacing every tab.
    ///
    /// The file is one document; its top-level headings become the tabs.
...
mod tests {
    ...
    #[test]
    fn save_as_writes_every_tab_in_order() {
        let dir = temp_dir();
        let target = dir.join("tabs.md");
    ...
    #[test]
    fn opening_a_file_with_headings_gives_one_tab_each() {
        let dir = temp_dir();
    ...
    #[test]
    fn opening_replaces_the_tabs_that_were_open() {
        let dir = temp_dir();
    ...
    #[test]
    fn the_notepad_name_is_not_written_to_the_file() {
        let dir = temp_dir();
    ...
    #[test]
    fn saving_is_not_confused_by_an_empty_tab_in_the_middle() {
        let dir = temp_dir();
