...
/// theirs; the toolbar and the section strip share a fill.
#[derive(Clone, Copy, PartialEq, Eq, Debug, Serialize, Deserialize)]
pub struct Colours {
    pub window_background: Rgba,
    /// Behind the toolbar and the section strip both.
    pub bar_fill: Rgba,
    pub separator: Rgba,
    ...
    #[serde(alias = "tab_selected_fill")]
    pub section_selected_fill: Rgba,
    #[serde(alias = "tab_selected_label")]
    pub section_selected_label: Rgba,
    /// Hover: the section under the pointer, and the settings cog under it.
    pub highlight: Rgba,
...
impl Colours {
    pub const fn light() -> Colours {
        Colours {
            ...
            section_selected_fill: Rgba::rgb(144, 209, 255),
            section_selected_label: Rgba::rgb(0, 83, 125),
    ...
    pub const fn dark() -> Colours {
        Colours {
            ...
            section_selected_fill: Rgba::rgb(0, 92, 128),
            section_selected_label: Rgba::rgb(192, 222, 255),
