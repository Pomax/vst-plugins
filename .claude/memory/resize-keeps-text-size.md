...
`tools/mini-host/src/tools/uitests/host-resize-target.mp4` is that film, beside
...
`tools/mini-host/src/crates/mini-host/src/app/place.rs`: the plugin's frame timer
